...
from pico_agent import LLM, AgentCapability, AgentType, LLMFactory, TraceService, agent
...
def test_full_observability_flow():
    ...
    adapter_with_tracing = LangChainAdapter(chat_model=mock_chat_model, tracer=tracer, model_name="mock-gpt")
