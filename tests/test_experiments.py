...
from pico_agent import LLM, AgentLocator, ExperimentRegistry, LLMFactory, VirtualAgentManager
...
def test_ab_testing_distribution():
    ...
    experiments.register_experiment(public_name="sales_bot", variants={"sales_v1": 0.5, "sales_v2": 0.5})
...
def test_weighted_routing_skew():
    ...
    experiments.register_experiment(public_name="feature_bot", variants={"canary": 1.0, "legacy": 0.0})
